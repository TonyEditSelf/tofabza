...
export const SERVICE_DETAILS = {
  "social-media-growth": {
    ...
    icon: "Share2",
    description:
      "I create and run social media strategies that do more than look good — they drive real business outcomes. From sharp content calendars to data-backed growth experiments, I  handle every layer so your brand stays consistent, relevant, and visible to the right people.",
    benefits: [
  ...
  "automation-systems": {
    ...
    benefits: [
      ...
      "AI-powered agents handling enquiries, calls, and follow-ups 24/7",
      "No unnecessary complexity — built to fit your existing stack.",
    ],
    deliverables: [
      "Workflow audit & mapping",
      "CRM setup / optimisation",
      "Automation builds (Zapier / Make / n8n)",
      "Payslip, invoice & report generation",
