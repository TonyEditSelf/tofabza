...
export const SERVICE_DETAILS = {
  ...
  "website-design": {
    ...
    icon: "Layout",
    description:
      "Your website and app are often the first impression — I make sure they land. I design and build premium, fast websites and apps with clean code, thoughtful UX, and conversion-focused layouts. Built on modern stacks, optimised for SEO, and built to perform from day one.",
    benefits: [
