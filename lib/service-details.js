        ...
        items: [
          {
            ...
            items: [
              ...
              { label: "YouTube Shorts", icon: "SiYoutubeshorts" },
          ...
          },
          {
            ...
            items: [
              { label: "Canva Pro", icon: "SiCanva" },
              { label: "CapCut", icon: "Scissors" },
              { label: "Later / Buffer", icon: "SiBuffer" },
              { label: "Meta Business Suite", icon: "SiMeta" },
        ...
        items: [
          ...
          },
          {
            ...
            items: [
              ...
              { label: "Headless", icon: "ShoppingBag" },
            ],
          },
          {
            title: "Media & Performance",
            items: [
              { label: "ImageKit", icon: "ImageIcon" },
              { label: "CDN optimisation", icon: "Layout" },
            ],
          },
          {
            title: "Auth & Security",
            items: [
              { label: "Google Auth", icon: "SiGoogleauthenticator" },
