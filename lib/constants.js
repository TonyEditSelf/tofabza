...
//   { label: "First Projects", href: "/first-projects" },
// ];
...
export const WHAT_I_BUILD = [
  {
    ...
    explain:
      "I build high-speed, SEO-ready websites and apps — so you never worry about slow load times or broken tech again.",
    icon: "Layout",
    items: [
      "Static Websites",
      "Mobile Apps",
  ...
  },
  {
    ...
    explain:
      "I eliminate the repetitive tasks that eat your day — leads followed up in seconds, not when you remember.",
    items: [
  ...
  },
  {
    ...
    title: "Grow",
    desc: "Your brand stays visible.",
    explain:
      "I take what you already have and turn it into consistent content. You approve. I handle the rest.",
    icon: "TrendingUp",
    items: [
...
export const HOW_IT_WORKS = [
  {
    step: "01",
    title: "Understand",
    desc: "30-minute conversation. I find your exact bottleneck. If I can't solve it, I'll tell you.",
  },
  {
    step: "02",
    title: "Strategize",
    desc: " I map what to build, what to automate, and in what order. No technical brief needed.",
  },
  {
    step: "03",
    title: "Build & Launch",
    desc: "I build, integrate, and launch. You review and approve. Done when it's live and performing.",
  },
  {
    step: "04",
    title: "Refine",
    desc: " I track what works, cut what doesn't, and improve what has potential.",
  },
];
...
export const WHAT_YOU_GET = [
  {
    ...
    desc: "Built for speed and conversion, not just to look good.",
  },
  {
    step: "02",
    title: "Manual work disappears",
    desc: "Leads captured, followed up, and qualified automatically.",
  },
  {
    step: "03",
    title: "Your brand stays visible without you",
    desc: "Content posted consistently, even when you're heads-down in client work.",
  },
  {
    step: "04",
    title: "You know exactly what to focus on",
    desc: "Real data, not guesswork.",
  },
];
