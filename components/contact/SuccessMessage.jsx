...
export default function SuccessMessage({ onReset }) {
  return (
    <div className="glass-card rounded-2xl p-12 text-center">
      ...
      <h3 className="font-display text-3xl font-semibold mb-4">Message received.</h3>
      <p className="text-muted-foreground leading-relaxed max-w-md mx-auto mb-8">
        Thank you for reaching out. A member of our team will get back to you within 24 hours with next steps.
      </p>
      <Button onClick={onReset} variant="outline" className="border-gold-500/40 text-foreground hover:bg-gold-500/10 hover:text-gold-500">
