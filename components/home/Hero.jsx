...
export default function Hero() {
  return (
    <section className="relative min-h-[92vh] flex items-center overflow-hidden pt-20 pb-10">
      ...
      {/* Abstract glow orbs */}
      <div className="absolute top-1/4 -left-40 w-[500px] h-[500px] rounded-full bg-brand-500/10 blur-[120px] animate-pulse-soft" />
      ...
      <div className="container relative z-10 py-20">
        <div className="max-w-5xl animate-fade-up">
          ...
          <div className="mt-16 flex items-center gap-10 flex-wrap text-sm">
            ...
            <div className="h-7 w-px bg-brand-500/20 hidden sm:block" />
            <div className="flex items-center gap-2 text-muted-foreground">
