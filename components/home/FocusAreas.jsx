      ...
      <div className="container">
        <div className="max-w-3xl mb-16">
          ...
          <h2 className="font-display text-4xl md:text-6xl font-semibold leading-tight">
            Three pillars. <span className="text-brand-gradient">One outcome.</span>
          </h2>
        </div>
          ...
          {FOCUS_AREAS.map((f) => {
            ...
            return (
              <div key={f.title} className="glass-card glass-card-hover rounded-2xl p-10">
                <div className="w-16 h-16 rounded-2xl bg-brand-gradient flex items-center justify-center mb-6 shadow-lg shadow-brand-500/20">
