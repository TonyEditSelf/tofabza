      ...
      <div className="container">
        <div className="max-w-3xl mb-16">
          ...
          <h2 className="font-display text-4xl md:text-6xl font-semibold leading-tight">
            Trusted by{" "}
            <span className="text-brand-gradient">ambitious brands</span>.
          </h2>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {TESTIMONIALS.map((t) => (
            <div key={t.name} className="cream-card rounded-2xl p-8">
              <Quote className="h-8 w-8 text-brand-500/60 mb-4" />
              <p
              ...
              <div className="flex items-center gap-4">
                ...
                />
                <div>
                  <div className="font-semibold" style={{ color: "var(--navy-900)" }}>
                    {t.name}
                  </div>
