          ...
          {WHAT_I_BUILD.map((s) => {
            ...
            return (
              <Link
                ...
                className="group relative rounded-2xl p-8 glass-card glass-card-hover transition-all"
              >
                {/* Top */}
                ...
                {/* CTA */}
                <div className="mt-6 text-xs uppercase tracking-[0.25em] text-gold-500 opacity-0 group-hover:opacity-100 transition-opacity font-semibold">
                  Explore →
                </div>
              </Link>
            );
