...
import { Share2, PenTool, Layout, Video, Target, Cog } from "lucide-react";
...
export default function ServiceHero({ service }) {
  ...
  return (
    <section className="relative pt-32 pb-16 overflow-hidden">
      ...
      <div className="absolute top-1/3 -left-40 w-[500px] h-[500px] rounded-full bg-brand-500/10 blur-[120px] animate-pulse-soft" />
      <div
