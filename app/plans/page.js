      ...
      <div className="container">
        ...
        <div className="text-center max-w-4xl mx-auto mb-20 animate-fade-up">
          ...
          <h1 className="font-display text-5xl md:text-7xl lg:text-[5.4rem] leading-[1.05] font-semibold mb-8">
            I'm not charging a <span className="text-brand-gradient">fee.</span>
            <br />
            I'm asking for{" "}
            <span className="text-brand-gradient">three things.</span>
          </h1>
        ...
        <div className="flex justify-center mb-24">
          <div className="glass-card rounded-2xl px-10 py-6 flex items-center gap-8 border border-brand-500/20">
            <div className="text-center">
              <p className="font-display text-5xl font-semibold text-brand-gradient">
                {SLOTS_REMAINING}
              </p>
            ...
            <div className="w-px h-12 bg-brand-500/20" aria-hidden="true" />
            <div className="text-center">
              <p
        ...
        <div className="py-24 max-w-5xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="font-display text-4xl md:text-6xl font-semibold leading-tight">
              <span style={{ color: "var(--cream-text)" }}>No invoice. </span>
              <span className="text-brand-gradient">Just a commitment.</span>
            </h2>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {REQUIREMENTS.map((r) => (
              <div
                key={r.number}
                className="glass-card glass-card-hover rounded-3xl p-8 flex flex-col gap-5 border border-brand-500/15 transition-all duration-500"
              >
                <span className="font-display text-5xl font-semibold text-brand-gradient leading-none">
                  {r.number}
                </span>
                <h3
        ...
        <div className="py-24 max-w-3xl mx-auto text-center">
          ...
          <h2 className="font-display text-4xl md:text-5xl font-semibold leading-tight mb-10">
            <span style={{ color: "var(--cream-text)" }}>Not everyone. </span>
            <span className="text-brand-gradient">Deliberately.</span>
          </h2>
          ...
          <div className="grid md:grid-cols-2 gap-4 text-left">
            {[
              ...
              <div
                key={i}
                className="glass-card rounded-2xl px-5 py-4 flex items-start gap-3 border border-brand-500/10"
              >
                <span className="text-brand-500 font-semibold text-sm shrink-0 mt-0.5">
                  ✓
                </span>
                <span
                  className="text-sm leading-relaxed"
            ...
            {[
              ...
              <div
                ...
                className={`rounded-2xl px-6 py-5 text-center border transition-all ${
                  tier.active
                    ? "glass-card-hover border-brand-500/40 brand-border-glow"
                    : "glass-card border-brand-500/10 opacity-60"
                }`}
        ...
        <div className="py-20">
          ...
          <div className="relative rounded-3xl overflow-hidden glass-card p-8 md:p-16 text-center">
            ...
            <div className="relative z-10 max-w-3xl mx-auto">
              <p className="text-xs uppercase tracking-[0.3em] text-brand-500 mb-6">
                {SLOTS_REMAINING} slots remaining
              </p>
              <h2 className="font-display text-4xl md:text-6xl font-semibold leading-tight mb-6">
                <span style={{ color: "var(--cream-text)" }}>Apply for a </span>
                <span className="text-brand-gradient">free slot.</span>
              </h2>
...
//             Simple systems.{" "}
//             <span className="text-brand-gradient">Real outcomes.</span>
//           </h1>
